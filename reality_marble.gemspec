...
Gem::Specification.new do |spec|
  ...
  spec.description = "Reality Marble (固有結界) is a next-generation mock/stub library for Ruby 3.4+ that leverages Refinements, TracePoint, Prism AST transformation, and metaprogramming to provide isolated, lexically-scoped test doubles. Inspired by TYPE-MOON's metaphor, it creates a temporary 'reality' where method behaviors are overridden only within specific test scopes.\n\nNOTE: This gem targets Ruby 3.4+ where frozen_string_literal is the default behavior."
